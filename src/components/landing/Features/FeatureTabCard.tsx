...
const FeatureTabCard = (props:Props) => {
    ...
    return (
        <motion.div
            ...
            className={`flex flex-col gap-10 justify-center items-center w-[40%] h-[360px] border border-[#363535] rounded-2xl max-md:w-full max-md:h-[290px] max-lg:w-2/3 max-lg:h-[300px] ${props.color}`}
        >
            <div className="flex flex-col gap-10 justify-center items-center w-[90%] h-[310px] border border-[#363535] rounded-2xl max-md:w-[90%] max-md:h-[250px] max-lg:w-[90%] max-lg:h-[250px] bg-black duration-500 z-50">
