...
export default function LoginForm() {
    ...
    return (
      <div className="shadow-input mx-auto w-full  max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-transparent border border-gray-700 flex flex-col justify-between h-[60%]">
        <div>
